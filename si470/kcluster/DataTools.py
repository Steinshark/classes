# File location: D:\Class\Firstie\si470\kcluster\DataTools.py]
# This class is used for data manipulation for ML on datasets
D:\Class\Firstie\si470\kcluster\DataTools.py
import numpy as np
import pandas as pd
...
def svd_decomp(matrix_type='sparse',n=10,matrix=None):
    ...
    times = {'start' : time()}
    printc(f"\tdecomposing matrix {matrix_type}","TAN")
    if matrix_type == 'sparse':
        ...
        matrix_reduced = cupy.matmul(cupy.matmul(U,cupy.diag(S)),Vt)
